      ...
      <span class="passwordMaxCharsMsg">You must specify at max 10 characters.</span>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              ...
              <button type="button" class="btn btn-info" onclick="createUserForm();"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;New user</button>
            </div><!-- /.col -->
          </div>
        </form>
      </div>
...
function createUserForm() {
  console.log("HI");
  window.location.href = '<?php echo WEB_ROOT; ?>views/userform.php';
  console.log("HI1");
}
</script>
</html>